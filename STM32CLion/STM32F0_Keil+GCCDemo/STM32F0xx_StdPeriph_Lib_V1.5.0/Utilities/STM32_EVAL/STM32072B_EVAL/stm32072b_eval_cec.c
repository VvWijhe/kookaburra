...
HDMI_CEC_Error HDMI_CEC_Init(void) {
    ...
    for (idx = 0; idx < 12; idx++) {
        HDMI_CEC_Follower_String[idx][1] = (uint8_t * )
        "0";
    }
...
void HDMI_CEC_CommandCallBack(void) {
    ...
    switch (HDMI_CEC_RX_MessageStructPrivate.Opcode) {
        case HDMI_CEC_OPCODE_REPORT_PHYSICAL_ADDRESS:
            ...
            HDMI_CEC_Follower_String[(HDMI_CEC_DeviceMap[DeviceCount].LogicalAddress)][1] = (uint8_t * )
            "1";
            DeviceCount++;
            break;
        ...
        case HDMI_CEC_OPCODE_GET_CEC_VERSION:
            ...
            HDMI_CEC_TX_MessageStructPrivate.Header = ((MyLogicalAddress << 4) |
                                                       (HDMI_CEC_RX_MessageStructPrivate.Header >> 4));
        ...
        case HDMI_CEC_OPCODE_ROUTING_CHANGE:
            for (i = 0; i < 0x14; i++) {
                if ((HDMI_CEC_DeviceMap[i].PhysicalAddress_A == (HDMI_CEC_RX_MessageStructPrivate.Operande[1] >> 4)) &&
                    ...
                    (HDMI_CEC_DeviceMap[i].PhysicalAddress_D ==
                     (HDMI_CEC_RX_MessageStructPrivate.Operande[0] & 0x0F))) {
                    HDMI_CEC_MapStruct.LogicalAddress = (HDMI_CEC_RX_MessageStructPrivate.Header >> 0x4) & 0x0F;
                    HDMI_CEC_MapStruct.DeviceType = HDMI_CEC_RX_MessageStructPrivate.Operande[2];
...
HDMI_CEC_Error HDMI_CEC_CheckConnectedDevices(void) {
    ...
    if (errorstatus == HDMI_CEC_OK) {
        HDMI_CEC_Follower_String[0][1] = (uint8_t * )
        "1";
        i++;
        errorstatus = HDMI_CEC_OK;
    }
    ...
    if (errorstatus == HDMI_CEC_OK) {
        HDMI_CEC_Follower_String[1][1] = (uint8_t * )
        "1";
        i++;
        errorstatus = HDMI_CEC_OK;
    }
    ...
    if (errorstatus == HDMI_CEC_OK) {
        HDMI_CEC_Follower_String[2][1] = (uint8_t * )
        "1";
        i++;
        errorstatus = HDMI_CEC_OK;
    }
    ...
    if (errorstatus == HDMI_CEC_OK) {
        HDMI_CEC_Follower_String[3][1] = (uint8_t * )
        "1";
        i++;
        errorstatus = HDMI_CEC_OK;
    }
    ...
    if (errorstatus == HDMI_CEC_OK) {
        HDMI_CEC_Follower_String[4][1] = (uint8_t * )
        "1";
        i++;
        errorstatus = HDMI_CEC_OK;
    }
    ...
    if (errorstatus == HDMI_CEC_OK) {
        HDMI_CEC_Follower_String[5][1] = (uint8_t * )
        "1";
        i++;
        errorstatus = HDMI_CEC_OK;
    }
    ...
    if (errorstatus == HDMI_CEC_OK) {
        HDMI_CEC_Follower_String[6][1] = (uint8_t * )
        "1";
        i++;
        errorstatus = HDMI_CEC_OK;
    }
    ...
    if (errorstatus == HDMI_CEC_OK) {
        HDMI_CEC_Follower_String[7][1] = (uint8_t * )
        "1";
        i++;
        errorstatus = HDMI_CEC_OK;
    }
    ...
    if (errorstatus == HDMI_CEC_OK) {
        HDMI_CEC_Follower_String[8][1] = (uint8_t * )
        "1";
        i++;
        errorstatus = HDMI_CEC_OK;
    }
    ...
    if (errorstatus == HDMI_CEC_OK) {
        HDMI_CEC_Follower_String[9][1] = (uint8_t * )
        "1";
        i++;
        errorstatus = HDMI_CEC_OK;
    }
    ...
    if (errorstatus == HDMI_CEC_OK) {
        HDMI_CEC_Follower_String[10][1] = (uint8_t * )
        "1";
        i++;
        errorstatus = HDMI_CEC_OK;
    }
    ...
    if (errorstatus == HDMI_CEC_OK) {
        HDMI_CEC_Follower_String[11][1] = (uint8_t * )
        "1";
        i++;
        errorstatus = HDMI_CEC_OK;
    }
