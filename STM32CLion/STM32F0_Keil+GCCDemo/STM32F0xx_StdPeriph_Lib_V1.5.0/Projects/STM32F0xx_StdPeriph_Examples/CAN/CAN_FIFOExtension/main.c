...
static void Display_TransmittedMsg(uint8_t
PushNumber);
...
int main(void) {
    ...
    LCD_DisplayStringLine(LINE(0x3), (uint8_t * )
    MESSAGE2);
...
sprintf((
char*)text,"Send Message Num%d    = %d            ",dataindex+1,TxMessage.Data[0] );
...
void Display_ReceivedMsg(void) {
    ...
    /* Display Messages on the the LCD */
    LCD_DisplayStringLine(LINE(13), (uint8_t * )
    MESSAGE4);
