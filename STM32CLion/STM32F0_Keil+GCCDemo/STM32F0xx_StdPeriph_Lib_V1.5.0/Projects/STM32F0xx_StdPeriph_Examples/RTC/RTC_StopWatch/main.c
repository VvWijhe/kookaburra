...
int main(void) {
    ...
    while (1) {
        ...
        if (StartEvent != 0x0) {
            ...
            SecondFraction = (((256 - (uint32_t)
            RTC_GetSubSecond()) *1000) / 256);
        ...
        if (Button_State == LEFT_ON) {
            ...
            if (BackupIndex < 5) {
                ...
                if (BackupIndex < 2) {
                    ...
                    RTC_WriteBackupRegister(BKPDataReg[BackupIndex], (uint32_t)
                    RTC->TR);
                ...
                LCD_DisplayStringLine(LINE(16), (uint8_t * )
                MESSAGE4);
                LCD_DisplayStringLine(LINE(17), (uint8_t * )
                MESSAGE5);
...
*/
Table_TypeDef RTC_Get_Time(uint32_t
SecondFrac ,
...
static void Display_Init(void) {
    ...
    LCD_DisplayStringLine(LINE(18), (uint8_t * )
    MESSAGE2);
    ...
    LCD_DisplayStringLine(LINE(19), (uint8_t * )
    MESSAGE3);
