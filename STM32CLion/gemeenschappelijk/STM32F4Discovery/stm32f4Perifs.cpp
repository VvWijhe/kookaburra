 ...
 ******************************************************************************
 Dit bestand bevat drivers voor de STM32F4 Peripherals
******************************************************************************/
/* $Id: stm32f4Perifs.cpp 2279 2016-08-29 15:00:23Z ewout $                             */
...
/******************************************************************************/
    ...
    void USART1_IRQHandler(void)
    {
        ...
        if(USART1->SR & USART_FLAG_RXNE)
        {
            ...
            if((STM32Uart::rx_buffer[STM32Uart::rx_cnt++] = (uint8_t)(USART1->DR & 0x1ff))== 'q')
            {
                STM32Uart::rx_cnt=0;
