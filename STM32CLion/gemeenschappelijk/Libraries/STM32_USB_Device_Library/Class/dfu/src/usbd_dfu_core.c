...
usbd_dfu_CfgDesc[USB_DFU_CONFIG_DESC_SIZ]
__ALIGN_END;
...
#endif /* USB_OTG_HS_INTERNAL_DMA_ENABLED */
__ALIGN_BEGIN uint8_t
usbd_dfu_OtherCfgDesc[USB_DFU_CONFIG_DESC_SIZ]
__ALIGN_END;
...
/**
  ...
  */
static uint8_t *USBD_DFU_GetCfgDesc(uint8_t
speed,
uint16_t *length
)
{
...
/**
  ...
  */
static uint8_t *USBD_DFU_GetUsrStringDesc(uint8_t
speed,
...
*)usbd_dfu_StringDesc[index - USBD_IDX_INTERFACE_STR - 1], USBD_StrDesc, length);
return
USBD_StrDesc;
}
