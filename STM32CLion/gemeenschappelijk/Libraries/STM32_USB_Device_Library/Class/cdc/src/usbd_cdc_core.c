...
usbd_cdc_CfgDesc  [USB_CDC_CONFIG_DESC_SIZ]
__ALIGN_END;
...
#endif /* USB_OTG_HS_INTERNAL_DMA_ENABLED */
__ALIGN_BEGIN uint8_t
usbd_cdc_OtherCfgDesc  [USB_CDC_CONFIG_DESC_SIZ]
__ALIGN_END;
...
#endif /* USB_OTG_HS_INTERNAL_DMA_ENABLED */
__ALIGN_BEGIN uint8_t
APP_Rx_Buffer   [APP_RX_DATA_SIZE]
__ALIGN_END;
...
/**
  ...
  */
static uint8_t *USBD_cdc_GetCfgDesc(uint8_t
speed,
uint16_t *length
)
{
