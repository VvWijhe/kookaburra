...
/** @defgroup USBD_REQ_Private_Variables
  * @{
  */
extern __IO USB_OTG_DCTL_TypeDef
SET_TEST_MODE;
...
#endif /* USB_OTG_HS_INTERNAL_DMA_ENABLED */
__ALIGN_BEGIN uint32_t
USBD_default_cfg __ALIGN_END = 0;
...
USBD_StrDesc[USB_MAX_STR_DESC_SIZ]
__ALIGN_END;
/**
  * @}
  */
...
static void USBD_GetDescriptor(USB_OTG_CORE_HANDLE *pdev,
    ...
    switch (req->wValue >> 8) {
        ...
        case USB_DESC_TYPE_CONFIGURATION:
            pbuf = (uint8_t * )
            pdev->dev.class_cb->GetConfigDescriptor(pdev->cfg.speed, &len);
