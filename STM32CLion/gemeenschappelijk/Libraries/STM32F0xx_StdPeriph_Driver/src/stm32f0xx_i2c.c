...
void I2C_OwnAddress2Config(I2C_TypeDef *I2Cx, uint16_t Address, uint8_t Mask) {
    ...
    tmpreg &= (uint32_t)
    ~((uint32_t)(I2C_OAR2_OA2 | I2C_OAR2_OA2MSK));
...
/**
  ...
  * @retval None
  */
void I2C_TransferHandling(I2C_TypeDef *I2Cx, uint16_t Address, uint8_t Number_Bytes, uint32_t ReloadEndMode,
    ...
    tmpreg &= (uint32_t)
    ~((uint32_t)(I2C_CR2_SADD | I2C_CR2_NBYTES | I2C_CR2_RELOAD | I2C_CR2_AUTOEND | I2C_CR2_RD_WRN | I2C_CR2_START |
                 I2C_CR2_STOP));
...
void I2C_TimeoutAConfig(I2C_TypeDef *I2Cx, uint16_t Timeout) {
    ...
    tmpreg &= (uint32_t)
    ~((uint32_t) I2C_TIMEOUTR_TIMEOUTA);
...
void I2C_TimeoutBConfig(I2C_TypeDef *I2Cx, uint16_t Timeout) {
    ...
    tmpreg &= (uint32_t)
    ~((uint32_t) I2C_TIMEOUTR_TIMEOUTB);
