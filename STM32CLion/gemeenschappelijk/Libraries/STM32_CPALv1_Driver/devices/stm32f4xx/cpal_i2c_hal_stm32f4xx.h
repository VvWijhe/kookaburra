...
void CPAL_I2C_HAL_ITInit(CPAL_DevTypeDef Device, uint32_t Options, CPAL_DirectionTypeDef Direction,
                         CPAL_ProgModelTypeDef CPAL_ProgModel); /*<!This function configures NVIC and interrupts used
...
void CPAL_I2C_HAL_ITDeInit(CPAL_DevTypeDef Device, uint32_t Options, CPAL_DirectionTypeDef Direction,
                           CPAL_ProgModelTypeDef ProgModel); /*<!This function deinitialize NVIC and interrupts used
                                                                                                                                              by I2C Device  */
...
extern const uint32_t CPAL_I2C_DMA_TX_TC_FLAG[3];
extern const uint32_t CPAL_I2C_DMA_RX_TC_FLAG[3];

extern const uint32_t CPAL_I2C_DMA_TX_HT_FLAG[3];
extern const uint32_t CPAL_I2C_DMA_RX_HT_FLAG[3];

extern const uint32_t CPAL_I2C_DMA_TX_TE_FLAG[3];
extern const uint32_t CPAL_I2C_DMA_RX_TE_FLAG[3];
