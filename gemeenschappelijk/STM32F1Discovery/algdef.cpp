...
$Id: algdef.cpp 2126 2016-03-09 16:59:56Z ewout $
************************************************************************/
             ...
             const BreukRelAantalRelevanteNummers relCijfers)
{
    ...
    {
	const Int16 gg =  floor(fp);
		
	Int16 drijvend = floor((fp-gg)*nulWerkers[relCijfers-1]);
	Int16 tNoemer = nulWerkers[relCijfers-1];
